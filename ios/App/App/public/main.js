...
/* harmony import */ var _home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./app.component.html */ 75158);
...
AppComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_17__.Component)({
        selector: 'app-root',
        template: _home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
let Authentication = class Authentication {
    ...
    setLoginFlag() {
        localStorage.setItem(this.LOGIN_FLAG_KEY, '1');
        this.utils.storeDetails(_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.IS_USER_LOGGED_IN, '1').then(() => {
            this.authState.next(true);
        });
    }
    setLogout() {
        localStorage.removeItem(this.LOGIN_FLAG_KEY);
        this.utils.removeStoredDetails(_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.IS_USER_LOGGED_IN).then(() => {
            this.authState.next(false);
        });
    }
    isAuthenticated() {
...
Authentication = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
const environment = {
    ...
    razorpay_live: 'rzp_live_JncRuMt5pzKhOn',
...
// export const SERVER_URL: string = 'http://103.72.79.50/api-chargeman/';

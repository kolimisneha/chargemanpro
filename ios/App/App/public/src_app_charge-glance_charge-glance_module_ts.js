...
/* harmony import */ var _home_snehakolimi_workspaces_chargemanpro_node_modules_ngtools_webpack_src_loaders_direct_resource_js_charge_glance_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./charge-glance.page.html */ 56789);
        ...
        this.chargeReq.postRequestDetails(_constants__WEBPACK_IMPORTED_MODULE_2__.RELATIVE_URLS.CHARGING_SUMMARY, transaction_details).subscribe((res) => {
            if (res && res.length > 0) {
                ...
                res.map((item) => {
                    ...
                    item.chargevalue = (_e = parseFloat(item.chargevalue).toFixed(2)) !== null && _e !== void 0 ? _e : '0';
                    item.kwh = (_f = parseFloat(item.kwh).toFixed()) !== null && _f !== void 0 ? _f : '0';
                    item.capacity = (_g = parseFloat(item.capacity)) !== null && _g !== void 0 ? _g : '0';
...
ChargeGlancePage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _home_snehakolimi_workspaces_chargemanpro_node_modules_ngtools_webpack_src_loaders_direct_resource_js_charge_glance_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],

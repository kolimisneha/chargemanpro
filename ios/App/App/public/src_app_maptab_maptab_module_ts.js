...
MaptabPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        declarations: [_maptab_page__WEBPACK_IMPORTED_MODULE_1__.MaptabPage, src_components_loading_component_loading_component_component__WEBPACK_IMPORTED_MODULE_2__.LoadingComponentComponent],
...
/* harmony import */ var _home_snehakolimi_workspaces_chargemanpro_node_modules_ngtools_webpack_src_loaders_direct_resource_js_maptab_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./maptab.page.html */ 2299);
...
let MaptabPage = class MaptabPage {
    ...
    openChargeStartStopPage() {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            try {
                const updatedDetails = yield this.utils.getStoredUserDetails();
                const storedDeviceValue = (_a = (yield this.utils.getStoredDetails(_constants__WEBPACK_IMPORTED_MODULE_3__.KEYS.DEVICE_DETAILS))) === null || _a === void 0 ? void 0 : _a.value;
                let storedDeviceDetails = {};
                ...
                const chargerDetails = {
                    ...
                    rph: (_b = storedDeviceDetails.rph) !== null && _b !== void 0 ? _b : updatedDetails.rph,
                    deviceid: (_c = storedDeviceDetails.deviceid) !== null && _c !== void 0 ? _c : updatedDetails.deviceid,
                    devicetype: (_d = storedDeviceDetails.devicetype) !== null && _d !== void 0 ? _d : updatedDetails.devicetype
                };
                const chargeDetails = {
                    state: {
...
MaptabPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
        selector: 'app-maptab',
        template: _home_snehakolimi_workspaces_chargemanpro_node_modules_ngtools_webpack_src_loaders_direct_resource_js_maptab_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var _home_snehakolimi_workspaces_chargemanpro_node_modules_ngtools_webpack_src_loaders_direct_resource_js_charger_details_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./charger-details.component.html */ 1782);
...
ChargerDetailsComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        template: _home_snehakolimi_workspaces_chargemanpro_node_modules_ngtools_webpack_src_loaders_direct_resource_js_charger_details_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
"use strict";
module.exports = "agm-map {\n  width: 100%;\n  height: 100%;\n}\n\n[charging-status-container] {\n  position: fixed;\n  top: calc(env(safe-area-inset-top, 0px) + 60px);\n  left: 0;\n  right: 0;\n  z-index: 100;\n  display: flex;\n  align-items: center;\n  background: var(--ion-color-primary);\n  color: #fff;\n  margin-top: 0;\n  padding: 12px 16px;\n  cursor: pointer;\n}\n\n[charging-status-container] ion-icon:first-child {\n  font-size: 22px;\n  flex-shrink: 0;\n}\n\n[charging-status-container] ion-icon:last-child {\n  font-size: 16px;\n  color: rgba(255, 255, 255, 0.7);\n  margin-left: auto;\n}\n\n[charging-info] {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  grid-gap: 2px;\n  gap: 2px;\n  min-width: 0;\n  overflow: hidden;\n}\n\n[charging-info] ion-label:first-child {\n  font-size: 13px;\n  font-weight: 600;\n  white-space: nowrap;\n}\n\n[charging-tap] {\n  font-size: 11px;\n  opacity: 0.85;\n  white-space: nowrap;\n}\n\n[wallet-balance-container] {\n  position: fixed;\n  top: calc(env(safe-area-inset-top, 0px) + 68px);\n  left: 0;\n  right: 0;\n  z-index: 100;\n  display: flex;\n  align-items: center;\n  grid-gap: 10px;\n  gap: 10px;\n  margin: 8px 16px;\n  padding: 8px 14px;\n  border-radius: 8px;\n  background: #fff;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n  cursor: pointer;\n}\n\n[wallet-balance-container] ion-icon {\n  font-size: 22px;\n  flex-shrink: 0;\n}\n\n[wallet-label] {\n  flex: 1;\n  text-align: left;\n  font-size: 14px;\n  opacity: 0.9;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n[wallet-value] {\n  font-size: 15px;\n  font-weight: 700;\n  white-space: nowrap;\n  text-align: right;\n}\n\n[wallet-action] {\n  font-size: 12px;\n  font-weight: 600;\n  padding: 4px 10px;\n  border-radius: 6px;\n  background: var(--ion-color-primary);\n  color: #ffffff !important;\n  --color: #ffffff !important;\n  flex-shrink: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

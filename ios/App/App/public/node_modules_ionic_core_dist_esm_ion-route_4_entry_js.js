...
const _writeNavState = /*#__PURE__*/function () {
  var _ref = (0,_home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root, chain, direction, index, changed = false, animation) {
    try {
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,_home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (root) {
    const ids = [];
    let outlet;
...
const Router = class {
  ...
  push(_x6) {
    ...
    return (0,_home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, direction = 'forward', animation) {
      var _a;
  ...
  safeWriteNavState(_x7, _x8, _x9, _x0, _x1) {
    ...
    return (0,_home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, chain, direction, segments, redirectFrom, index = 0, animation) {
  ...
  runGuards() {
    ...
    return (0,_home_snehakolimi_workspaces_ev_chargeman_main_1_ev_chargeman_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (to = _this0.getSegments(), from) {
      if (from === undefined) {
